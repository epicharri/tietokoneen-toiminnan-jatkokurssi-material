...
Ttk-91 -konekielen harjoitteluun on olemassa Titokone-ohjelma ja TitoTrainer-harjoitteluympäristö. Näitä käsitellään tarkemmin luvussa 5.5. On suositeltavaa asentaa kyseinen ohjelma ja harjoitella Titotrainerilla jo tämän 5.1. luvun asioita opiskellessa, koska siten on helpompi ymmärtää tässä luvussa ilmaistuja käsitteitä. Esimerkiksi ajettaessa Titokoneella ohjelmaa, voi nähdä animaationa miten tieto kulkee muistista rekisteriin ja esimerkiksi TitoTrainerilla näet symbolitaulun sisällön. Näiden osaaminen myös helpottaa tämän luvun tehtävien tekemistä huomattavasti. Lisäohjeistuksena ttk-91 -ohjelmointiin voi käyttää myös Harri Kähkösen kirjoittamaa [ohjelmointiopasta.](https://github.com/epicharri/tito/blob/master/learning_materials/ttk-91ohjeita.md#opas-ttk-91-ohjelmointiin "TTK-91 Ohjelmointiopas")
